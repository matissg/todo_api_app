  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Api::V1::Tag" do
        expect {
          post :create, params: {
            data: { id: nil, attributes: { title: "Today" }, tag: {} }
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the new api/v1_tag" do
        ...
        post :create, params: {
          data: { id: nil, attributes: { title: "" }, tag: {} }
        }, session: valid_session
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the api/v1_tag" do
        ...
        put :update, params: {data: {type: "tasks", id: tag.id, attributes: {
          title:"" }}, id: tag.id, tag: {}}, session: valid_session
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
